    ...
    <div className="desktop:h-[900px] h-[833px] w-full overflow-hidden relative pt-[98px] desktop:pt-[159px] flex justify-center bg-black desktop:bg-herobg bg-mobileHeroBg bg-no-repeat bg-bottom">
      ...
      >
        ...
        <p className="desktop:text-[16px] text-base leading-8 mb-8">
          Welcome to Joyboy, a decentralized social media platform where your voice matters. Entirely open-sourced and community-managed, Joyboy empowers you to shape your social media experience
        </p>
...
<li>Decentralized Network: No central authority controls Nostr, ensuring true decentralization.</li>
<li>Pseudonymous Accounts: No need for an email or phone number to create an account.</li>
...
<li>Open Source: Anyone can contribute to the development of Nostr.</li>
     ...
     <div className="mt-12 p-8">
        ...
        <p className="p-5 tracking-wide leading-loose">
         Nostr operates by allowing users to publish and query notes through independent servers (relays), eliminating single points of failure and enhancing both privacy and reliability. This decentralized approach addresses the censorship issues faced by traditional social media platforms, offering a haven for controversial speech without the risk of
deplatforming.
Nostr's innovative approach to identity and user experience allows individuals to view feeds from any public key, offering diverse perspectives and a unique glimpse into other users' thoughts and
        </p>
    </div>
        ...
        <p className="p-5 tracking-wide leading-loose">
          Joyboy is a decentralized SocialFi platform that combines the Nostr protocol with Starknet's native account abstraction. Nostr, often referred to as the "Farcaster" of Bitcoin, emphasizes censorship resistance and is minimalistic and pure in design. Utilizing Bitcoin cryptographic primitives such as Schnorr signatures and concepts like NIP-13 Proof of Work as an anti-spam mechanism, Nostr is integrated into various Lightning wallets like @getAlby, Wallet of Satoshi and Blue wallet
Leveraging the power of Starknet's Account Abstraction, Joyboy enables users to control their Starknet accounts with their Nostr keypair. This integration allows us to build advanced features like fully trustless Social Pay and intent-based actions driven by messages on the social app. We can even explore Al-driven intent-based systems with trustless on-chain verification using ZKML provided by Giza Tech and Herodotus</p>
    </div>
     <div className="mt-12 p-8">
...
<li>Earning Opportunities: Users can earn rewards for their engagement through various monetization strategies.</li>
</ol>
        </p>
    </div>
    <div className="mt-2 px-8">
        ...
        <p className="p-5 tracking-wide leading-loose">
           <ol className="list-disc p-4">
<li>Digital Ownership with NFTs: Non-fungible tokens (NFTs) ensure secure and verifiable digital ownership.</li>
<li>Decentralized Governance with DAOs: Decentralized autonomous organizations (DAOs) facilitate community-driven decision-making.</li>
</ol>
        </p>
    </div>
    <div className="mt-2 px-8">
        ...
        <p className="p-5 tracking-wide leading-loose">
          SocialFi relies on several core components:
           <ol className="list-disc p-4">
<li>Monetization through Social Tokens: Creators can earn directly from their content.</li>
